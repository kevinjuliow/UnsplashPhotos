  ...
  return (
    <div className='collectionsCard'>
      <div style={{display:'flex' , height :'320px' }}>
        <div>
        <img src={preview_photos[0].urls.regular} alt="" style={{ width :'100%', height :"320px",  objectPosition:"center" , objectFit:'cover'}}/>
        </div>
        <div style={{display :'flex' , flexDirection : 'column' , height :'320px'  , marginLeft :'5px' , rowGap :"20px" }}>
